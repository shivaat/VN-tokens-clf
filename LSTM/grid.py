...
# load data
data = pickle.load(open("sequencesWin2.pkl", 'rb'))

# load word2vec model 
model = Word2Vec.load("../../Desktop/word2vec/models/wiki_iter=5_algorithm=skipgram_window=10_size=300_neg-samples=10.m")
